...
contract("BangCash", accounts => {
    ...
    before(async () => contract = await BangCash.deployed());
    ...
    it("Payable function should not be called from a contract", async () => {
        ...
        return handleErrorTransaction(() => dcontract.bangCashCall.sendTransaction(contract.address));
    });
});
